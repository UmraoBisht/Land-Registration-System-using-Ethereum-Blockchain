  ...
  async function connectToMetamask() {
    ...
    if (window.ethereum) {
      try {
        ...
        // 0x6d0b317148909Cd9FCE528AE75a5aEd539EaDeCd
      ...
      toast("Please download metamask");
    }
  }

  return (
    <section className="flex justify-around items-center pt-20 text-center h-screen bg-slate-100">
      <div className="flex flex-col justify-center items-center">
        <div className="flex flex-col justify-center items-center">
          <h4 className="font-bold text-2xl">Secure.</h4>
          <h4 className="font-bold text-2xl">Transparent.</h4>
          <h4 className="font-bold text-2xl">Trustless.</h4>
        </div>

        <button
          type="button"
          className="text-gray-900 bg-white hover:bg-gray-100 border border-gray-200 focus:ring-4 focus:outline-none focus:ring-gray-100 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-gray-600 dark:bg-gray-800 dark:border-gray-700 dark:text-white dark:hover:bg-gray-700 me-2 mb-2 mt-2"
      ...
      <div className="flex justify-center items-center">
        <img
          ...
          src="/src/assets/technology-blockchain.jpg"
